...
class UserFriendshipTest < ActiveSupport::TestCase
  ...
  test "that creating a friendship works without raising an exception" do
   ...
   context "a new instance" do
   		setup do
   			@user_friendship = UserFriendship.new user: users(:jason), friend: (:mike)
   		end
   ...
   context "#send_request_email" do
   		setup do
   			@user_friendship = UserFriendship.create user: users(:jason), friend: (:mike)
   		end
   ...
   context "#accept!" do
         ...
         should "accept the mutual friendship" do
            @user_friendship.accept!
            assert_equal 'accepted', @user_friendship.mutual_friendship
         end
   end	

   context ".request" do
   		setup "create two user friendships" do
   ...
   context "on destroy" do
      ...
      should "delete the mutual friendship" do
         assert !UserFriendship.destroy?(@friendship2.id)
      end  
   end	
